...
class Replay(Base):
    ...
    def get_csv_name(self):
        return os.path.join(OPT.csv_folder, f"{OPT.dataset}_{OPT.num_tasks}tasks_{self.name.replace('_','')}{self.buffer.size}_{OPT.model.replace('_','')}_epochs{OPT.epochs}.csv")